...
COPY --chown=dev:dev . /workspace/an-encryption-library
RUN mkdir -p /workspace/build/an-encryption-library && \
    cd /workspace/build/an-encryption-library && \
    cmake /workspace/an-encryption-library && \
